def oper(input):
    ...
    if "times of india" in input:
        webbrowser.open("https://www.toi.com/")
        espeak.synth("opening times of india")
    if "w3schools" in input:
        webbrowser.open("https://www.w3schools.com/")
        espeak.synth("opening W 3 Schools")
