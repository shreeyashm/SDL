...
churn_data_raw <- read_csv("SDLTelecom/WA_Fn-UseC_-Telco-Customer-Churn.csv")
...
# save the model
save_model_hdf5(model_keras, 'SDLTelecom/customer_churn.hdf5')
...
save(list = ls(), file = 'SDLTelecom/customer_churn.RData')
